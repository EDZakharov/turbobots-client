...
export function QuestionSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
...
export function DashboardSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export function ShopSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export function AccountSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export function SettingsSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function ExitSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path
                ...
                className={className}
                fillOpacity="1"
                d="M0,96L6.2,90.7C12.3,85,25,75,37,64C49.2,53,62,43,74,53.3C86.2,64,98,96,111,128C123.1,160,135,192,148,213.3C160,235,172,245,185,234.7C196.9,224,209,192,222,181.3C233.8,171,246,181,258,202.7C270.8,224,283,256,295,272C307.7,288,320,288,332,250.7C344.6,213,357,139,369,112C381.5,85,394,107,406,106.7C418.5,107,431,85,443,112C455.4,139,468,213,480,250.7C492.3,288,505,288,517,272C529.2,256,542,224,554,186.7C566.2,149,578,107,591,112C603.1,117,615,171,628,160C640,149,652,75,665,48C676.9,21,689,43,702,85.3C713.8,128,726,192,738,202.7C750.8,213,763,171,775,170.7C787.7,171,800,213,812,208C824.6,203,837,149,849,112C861.5,75,874,53,886,48C898.5,43,911,53,923,58.7C935.4,64,948,64,960,80C972.3,96,985,128,997,149.3C1009.2,171,1022,181,1034,192C1046.2,203,1058,213,1071,229.3C1083.1,245,1095,267,1108,277.3C1120,288,1132,288,1145,266.7C1156.9,245,1169,203,1182,186.7C1193.8,171,1206,181,1218,197.3C1230.8,213,1243,235,1255,218.7C1267.7,203,1280,149,1292,138.7C1304.6,128,1317,160,1329,149.3C1341.5,139,1354,85,1366,69.3C1378.5,53,1391,75,1403,74.7C1415.4,75,1428,53,1434,42.7L1440,32L1440,320L1433.8,320C1427.7,320,1415,320,1403,320C1390.8,320,1378,320,1366,320C1353.8,320,1342,320,1329,320C1316.9,320,1305,320,1292,320C1280,320,1268,320,1255,320C1243.1,320,1231,320,1218,320C1206.2,320,1194,320,1182,320C1169.2,320,1157,320,1145,320C1132.3,320,1120,320,1108,320C1095.4,320,1083,320,1071,320C1058.5,320,1046,320,1034,320C1021.5,320,1009,320,997,320C984.6,320,972,320,960,320C947.7,320,935,320,923,320C910.8,320,898,320,886,320C873.8,320,862,320,849,320C836.9,320,825,320,812,320C800,320,788,320,775,320C763.1,320,751,320,738,320C726.2,320,714,320,702,320C689.2,320,677,320,665,320C652.3,320,640,320,628,320C615.4,320,603,320,591,320C578.5,320,566,320,554,320C541.5,320,529,320,517,320C504.6,320,492,320,480,320C467.7,320,455,320,443,320C430.8,320,418,320,406,320C393.8,320,382,320,369,320C356.9,320,345,320,332,320C320,320,308,320,295,320C283.1,320,271,320,258,320C246.2,320,234,320,222,320C209.2,320,197,320,185,320C172.3,320,160,320,148,320C135.4,320,123,320,111,320C98.5,320,86,320,74,320C61.5,320,49,320,37,320C24.6,320,12,320,6,320L0,320Z"
            ></path>
        </svg>
    );
}
...
export function HomeSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export function RobotSvg({ size = DEFAULT_SIZES, className = '' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className={className}
